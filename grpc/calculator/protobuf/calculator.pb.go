...
func (x *CalcResponse) GetR() float64 {
	if x != nil {
		return x.R
	}
	return 0
...
var file_calculator_proto_rawDesc = []byte{
	...
	,
...
var file_calculator_proto_depIdxs = []int32{
	0, // 0: CalculatorService.calc:input_type -> CalcRequest
	1, // 1: CalculatorService.calc:output_type -> CalcResponse
...
func (c *calculatorServiceClient) Calc(ctx context.Context, in *CalcRequest, opts ...grpc.CallOption) (*CalcResponse, error) {
	out := new(CalcResponse)
	err := c.cc.Invoke(ctx, "/CalculatorService/calc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedCalculatorServiceServer) Calc(context.Context, *CalcRequest) (*CalcResponse, error) {
...
func _CalculatorService_Calc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/CalculatorService/Calc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServiceServer).Calc(ctx, req.(*CalcRequest))
	}
